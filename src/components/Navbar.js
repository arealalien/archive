      ...
      <nav className="navbar">
          <div className="navbar-inner view-width-wide">
              <div className="navbar-inner-left">
                  <div className="navbar-inner-left-logo">
              ...
              <div className="navbar-inner-center">
                  <div className="navbar-inner-center-searchbar">
                      <svg className="navbar-inner-center-searchbar-icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" version="1.1">
                          <title>Search</title>
              ...
              <div className="navbar-inner-right">
                  <div className="navbar-inner-right-profile">
                      <div className="navbar-inner-right-profile-container">
