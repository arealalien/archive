...
-- AlterTable
ALTER TABLE `comment` ADD COLUMN `dateCommented` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3);

-- AlterTable
ALTER TABLE `post` ADD COLUMN `datePosted` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3);

-- AlterTable
ALTER TABLE `subscription` ADD COLUMN `dateSubscribed` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
